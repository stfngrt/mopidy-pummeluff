...
class Extension(mopidy.ext.Extension):
    ...
    def get_config_schema(self):
        ...
        schema['en_gpio']      = mopidy.config.Boolean()
        schema['rfid_bus']     = mopidy.config.Integer()
        schema['rfid_dev']     = mopidy.config.Integer()
        schema['rfid_pin_rst'] = mopidy.config.Integer()
        schema['rfid_pin_irq'] = mopidy.config.Integer()
        return schema
